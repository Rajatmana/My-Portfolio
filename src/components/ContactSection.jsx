  ...
  return (
    <section id="contact" className={`min-h-screen flex items-center justify-center px-4 sm:px-6 lg:px-8 ${
      ...
      <div className="max-w-4xl mx-auto w-full">
        ...
        >
          <motion.a 
            href="mailto:rajatmana02@gmail.com" 
          ...
          >
            ...
            <div className="flex-1">
              ...
              <p className={`font-medium text-lg ${darkMode ? 'text-white' : 'text-gray-900'}`}>rajatmana02@gmail.com</p>
            </div>
          </motion.a>

          <motion.a 
            href="tel:+919749031564"
            className={`flex items-center space-x-4 p-6 rounded-xl transition-all duration-300 ${
              darkMode ? 'bg-slate-700/50 hover:bg-slate-700 border border-slate-600' : 'bg-white hover:bg-gray-50 border border-gray-200'
            } shadow-lg`}
            whileHover={{ scale: 1.02, x: 5 }}
          >
            ...
            <div className="flex-1">
              ...
              <p className={`font-medium text-lg ${darkMode ? 'text-white' : 'text-gray-900'}`}>+91 9749031564</p>
            </div>
          </motion.a>

          <div className="flex justify-center space-x-6 pt-8">
            <motion.a 
              href="https://github.com/Rajatmana" 
              target="_blank" 
            ...
            <motion.a 
              href="https://www.linkedin.com/in/rajat-mana-46605a250/" 
              target="_blank" 
              rel="noopener noreferrer"
              whileHover={{ scale: 1.1, y: -5 }}
              className={`p-4 rounded-full transition-all duration-300 ${
