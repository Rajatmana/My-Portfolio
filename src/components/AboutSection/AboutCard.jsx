  ...
  return (
    ...
    >
      ...
      <p className={`text-lg leading-relaxed mb-6 ${
        ...
        Computer Science student at <span className="font-semibold">Chitkara University</span> with a stellar <span className={`font-bold ${darkMode ? 'text-blue-400' : 'text-green-600'}`}>8.7 CGPA</span>. 
        Currently working as a Full Stack Intern at <span className="font-semibold">Innova Solutions</span>, 
        where I build cutting-edge web applications using React.js and .NET.
      </p>
